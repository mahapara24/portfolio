      ...
      <div className="text-left sm:px-6 sm:py-16">
        <div className="text-2xl ml-4 items-left text-justify text-white font- font-bold leading-tight sm:text-6xl">
          ...
          <div className="flex justify-between gap-8">
            <button className="px-2 py-2 text-base mt-3 flex items-start font-semibold sm:mt-8 sm:text-xl sm:font-semibold text-black bg-custom-red sm:px-6 sm:py-3 sm:my-3 sm:flex sm:items-center rounded-md border-2 border-custom-red hover:bg-custom-red/90">
              <a
